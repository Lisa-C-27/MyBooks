...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2018 at 06:13 AM
...
(1, 'Jonathon', 'Campbell', 'Bookkeeper', 1),
(2, 'Lisa', 'Clark', 'Manager', 2),
(3, 'Jane', 'Doe', 'Manager', 3),
(4, 'Tanya', 'Lewis', 'Bookkeeper', 4);
...
(2, '', 'https://www.enotes.com/topics/tale-of-two-cities', 2),
...
(1, 2, 1, '2018-04-18 14:24:06'),
(2, 3, 3, '2018-04-18 14:24:06'),
(3, 2, 4, '2018-04-18 14:25:01'),
(4, 2, 5, '2018-04-18 14:25:23'),
(5, 3, 6, '2018-04-18 14:25:23'),
(6, 1, 7, '2018-04-18 14:25:56'),
(7, 4, 8, '2018-04-18 14:25:56'),
(8, 2, 9, '2018-04-18 14:26:14'),
(9, 1, 2, '2018-05-02 13:27:28');
...
(1, 'jcampbell', '$2y$10$UJCwQdH6e/02ZmXW2taYJuL91K5h6jISL8Dxqi7zM9xmFRz41x9va'),
(2, 'lclark', '$2y$10$2AWoBgfXKxNZU3hRUSITIejcScpBzGvMHP1hy7UVjCc5TPhczTEJm'),
(3, 'jdoe', '$2y$10$TJf1x1PuoKb053uiT5y7L.Bk8qHMMR9FKCkq5aNQC6laOE1JP2iJa'),
(4, 'tlewis', '$2y$10$EHOTTeCVafYy1.YLUPvvPuH/2ey2ubhUCtRg.uQ.v19YL6EJh3vYG');
...
--
ALTER TABLE `admin`
  MODIFY `adminID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `update_book`
  MODIFY `updateID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `userlogin`
--
ALTER TABLE `userlogin`
  MODIFY `userLoginID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
