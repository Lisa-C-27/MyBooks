...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2018 at 11:22 AM
...
(4, 'Another', 'User', 'Bookkeeper', 8),
(5, 'Lisa', 'Clark', 'Manager', 9),
(6, 'Jane', 'Doe', 'Manager', 10);
...
(14, 'A Tale of Two Cities', 'A Tale of Two Cities', 1859, 'Historical Fiction', 200, 'English', 2, 2),
(15, 'Test Book to Delete', NULL, 2000, 'English', 300, 'English', 1, 3),
(16, 'Test Book to Delete 2', NULL, 2000, 'English', 300, 'English', 2, 3),
(17, 'Test', 'Test', 2001, 'Test', 120, 'Test', 10, 9),
(18, 'a', 'a', 2000, 'a', 100, 'a', 11, 10),
(19, 'b', 'b', 2000, 'b', 100, 'b', 12, 11);
...
(9, '../img/BookCovers/default.png'),
(10, '../img/BookCovers/default.png'),
(11, '../img/BookCovers/default.png');
...
(2, 5, 19, '2018-04-17 18:52:27'),
(3, 5, 17, '2018-04-17 19:18:57');
...
(8, 'test3', '$2y$10$UJCwQdH6e/02ZmXW2taYJuL91K5h6jISL8Dxqi7zM9xmFRz41x9va'),
(9, 'lclark', '$2y$10$2AWoBgfXKxNZU3hRUSITIejcScpBzGvMHP1hy7UVjCc5TPhczTEJm'),
(10, 'jdoe', '$2y$10$TJf1x1PuoKb053uiT5y7L.Bk8qHMMR9FKCkq5aNQC6laOE1JP2iJa');
...
--
ALTER TABLE `admin`
  MODIFY `adminID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `author`
--
ALTER TABLE `author`
  MODIFY `AuthorID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `bookplot`
  MODIFY `BookPlotID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `bookranking`
--
ALTER TABLE `bookranking`
  MODIFY `RankingID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `image`
--
ALTER TABLE `image`
  MODIFY `imageID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `userlogin`
  MODIFY `userLoginID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
