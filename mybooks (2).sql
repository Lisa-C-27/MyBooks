...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2018 at 08:42 AM
...
(13, 'test', NULL, 500, '', 100, '', 6, 3),
(14, 'test2', NULL, 400, '', 100, '', 7, 3);
...
--
ALTER TABLE `book`
  MODIFY `BookID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `userlogin`
  MODIFY `userLoginID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
