...
<!--
                <li class="nav-item">
                    <form class="form-inline my-2 my-lg-0 mr-lg-2" method="post" action="../../controller/search.php">
                        <div class="input-group">
                            <input class="form-control" type="text" placeholder="Search books..." name="search">
